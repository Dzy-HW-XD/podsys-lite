...
- LiveOS 内核参数：`boot=casper url=http://IP:5001/iso/liveos.iso root=/dev/ram0 ramdisk_size=33554432 ip=dhcp ignore_uuid console=tty0 net.ifnames=0 biosdevname=0 cloud-config-url=/dev/null ---`
